...
public class GuestDashboard extends javax.swing.JFrame {
    ...
    public void updateWeatherData() {
        ...
        String city = JOptionPane.showInputDialog("Please enter city name:");
    ...
    private void initComponents() {
        ...
        jLeftPanel.add(jLocationSearchField, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 140, -1));
        ...
        jLeftPanel.add(jSearchButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 70, 23));

        jWeatherCondition.setFont(new java.awt.Font("SF UI Display", 0, 24)); // NOI18N
        jWeatherCondition.setText("Partly cloudy");
        jLeftPanel.add(jWeatherCondition, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, -1, 28));

        jWeatherConditionImage.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLeftPanel.add(jWeatherConditionImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 320, 73, 62));

        jTemperature.setFont(new java.awt.Font("SF UI  Text SemBd", 1, 48)); // NOI18N
        jTemperature.setText("28°c");
        jLeftPanel.add(jTemperature, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 125, 70));

        jWeekdayName.setFont(new java.awt.Font("SF UI  Text", 0, 36)); // NOI18N
        jWeekdayName.setText("Monday");
        jLeftPanel.add(jWeekdayName, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 240, -1));

        jCurrentTime.setFont(new java.awt.Font("SF UI  Text", 0, 18)); // NOI18N
        jCurrentTime.setText("09:00 PM");
        jLeftPanel.add(jCurrentTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 85, 30));

        jLabel1.setFont(new java.awt.Font("SF UI  Text", 0, 14)); // NOI18N
        jLabel1.setText("Feels like");
        jLeftPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 500, 67, -1));

        jTemperatureFeelslike.setFont(new java.awt.Font("SF UI  Text", 0, 24)); // NOI18N
        jTemperatureFeelslike.setText("25°c");
        jLeftPanel.add(jTemperatureFeelslike, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, 62, 18));

        jLabel5.setText("Selected city");
        jLeftPanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, -1));

        jLocation.setFont(new java.awt.Font("SF UI  Text", 0, 24)); // NOI18N
        jLocation.setText("Badulla");
        jLeftPanel.add(jLocation, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 190, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 85)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("F");
        jLeftPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, -10, 50, 140));

        jLabel3.setFont(new java.awt.Font("SF UI Display", 1, 36)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel3.setText("orecast");
        jLeftPanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, -1, -1));

        jLabel4.setFont(new java.awt.Font("SF UI Display", 0, 36)); // NOI18N
        jLabel4.setText("riend");
        jLeftPanel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, -1, -1));
