...
public class ChangeCity extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jHomeAddressTextField.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        ...
        jWorkAddressTextField.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        ...
        jLabel3.setText("Change your city");
    ...
    private void jNextButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jNextButtonMouseClicked
        ...
        if (jHomeAddressTextField.getText().isBlank() || jWorkAddressTextField.getText().isBlank()) {
            JOptionPane.showMessageDialog(null, "Oops! Please fill out all the required fields to proceed.","Error",JOptionPane.ERROR_MESSAGE);
        }
        else {
